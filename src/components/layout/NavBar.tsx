  ...
  return (
    <div className="fixed bottom-10 md:bottom-80 xl:bottom-32 right-2 md:right-16 xl:right-80  z-50 flex flex-col gap-4 items-center justify-center p-3 rounded-2xl  bg-black/30  md:bg-white/30 border border-black/10 md:border-white/10 shadow-lg">
      ...
      <div className={iconClass}>
        ...
        <h3
          className={`hidden iphone:block mobile:hidden ${device != "iphone" ? "text-white" : ""}`}
          onClick={() => dispatch(setDevice("iphone"))}
        >
          iphone
        </h3>
        <h3
          className={`hidden mobile:block md:hidden ${device != "iphone" ? "text-white" : ""}`}
          onClick={() => dispatch(setDevice("iphone"))}
        >
          mobile
        </h3>
        ...
        <h3
          className={`hidden 2xl:block 3xl:hidden ${device != "2xl" ? "text-white" : ""}`}
          onClick={() => dispatch(setDevice("2xl"))}
        >
          2xl
        </h3>
        <h3
          className={`hidden 3xl:block ${device != "2xl" ? "text-white" : ""}`}
          onClick={() => dispatch(setDevice("2xl"))}
        >
          2xl
        </h3>
      ...
      <div className={iconClass}>
        <h5 className="text-white">{valuepy[indexPy]}</h5>
      </div>
      {/* <div className={iconClass}>
      ...
      {/* <div className={iconClass}>
        ...
        >
          <Plus
            ...
            onClick={() => dispatch(setStyle({ indexPy: indexPy + 1 }))}
          />
        </button>
      </div>
      <div className={iconClass}>
